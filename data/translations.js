export const translations = {
  tr: {
    ...
    home: {
      ...
      viewExplorer: "Veri Gezgini",
      ekonomiTitle: "Türkiye Ekonomisi — Yirmi Dört Yılın Tekrarlayan Kuralları",
      ekonomiSub: "Bireysel proje · 2026, devam ediyor",
      ekonomiDesc: "Türkiye ekonomisi hakkında \"her zaman şöyle olur\" diyebileceğim bir şey var mı, yoksa her dönem kendine mi benziyor? 2002'den bugüne 33 aylık ve günlük seriyi topladım, akla gelen iddiaları tek tek test ettim. Ayakta kalanları da çökenleri de yazdım — hangi iddianın çöktüğünü bilmek, hangisinin durduğunu bilmek kadar önemli. Çıktı: beş yayın sayfası ve okurun kendi sorusunu sorabildiği bir veri gezgini.",
      ekonomiResult: "Testten geçen yedi kural var. En nettleri: cari işlemler dengesi yirmi dört yılın yirmi dördünde de Ağustos'ta Mart'tan iyi çıkıyor ve bu salınımın %82'si net turizm geliriyle açıklanıyor; reel bütçe açığı yirmi yılın on beşinde Aralık'ta zirve yapıyor; yedi faiz indirimi döngüsünün altısında enflasyon düşüyordu. Kurun enflasyona geçişi üç ay ufkunda 0,09'dan 0,77'ye çıktı. Dört iddia ise testten geçemedi — \"seçimden sonra kur çalkalanır\" ve \"seçim öncesi bütçe açılır\" dahil. Kendi varsayım denetimim üç sonucumu daha geri çektirdi: seviye Taylor katsayıları sahte regresyondu, Bai-Perron kırılma tarihleri otokorelasyon arındırılınca kayboldu, bir ilişki tek bir gözleme dayanıyordu. Üçünü de sayfalarda yazdım.",
      ekonomiMethods: "Bai-Perron çoklu yapısal kırılma (kendi dinamik programlama uygulamam), Chen-Liu tipli aykırı değer tespiti, ay eşleştirmeli plasebo ve permütasyon testleri, Benjamini-Hochberg yanlış keşif düzeltmesi, 2×12 merkezî hareketli ortalamayla mevsimsel ayrıştırma ve negatif kontrol, gecikme-artırımlı yerel projeksiyon (Montiel Olea &amp; Plagborg-Møller, 2021), Zivot-Andrews kırılmalı birim kök testi, sahte regresyon denetimi, PPK karar günleriyle yüksek frekanslı olay çalışması. Python (pandas, statsmodels), TCMB EVDS API'si; ham veriden bütün tablo ve grafikler tek komutla yeniden üretilebiliyor.",
  ...
  en: {
    ...
    home: {
      ...
      viewAnalysis: "Open the Analysis",
      viewExplorer: "Data Explorer",
      ekonomiTitle: "The Turkish Economy — What Repeats Across Twenty-Four Years",
      ekonomiSub: "Solo project · 2026, ongoing",
      ekonomiDesc: "Is there anything about the Turkish economy I can state as a general rule, or does every period only resemble itself? I collected 33 monthly and daily series from 2002 onward and tested the usual claims one by one. I wrote up both the ones that survived and the ones that collapsed — knowing which claim fails matters as much as knowing which holds. The output: five published sections and a data explorer where the reader can ask their own question.",
      ekonomiResult: "Seven rules survived testing. The clearest: in twenty-four years out of twenty-four, the current account balance is better in August than in March of the same year, and 82% of that swing is explained by net tourism revenue; the real budget deficit peaks in December in fifteen of twenty years; in six of seven easing cycles inflation was already falling. Exchange rate pass-through to inflation rose from 0.09 to 0.77 at a three-month horizon. Four claims failed — including \"the lira gets volatile after elections\" and \"the budget opens up before elections.\" My own assumption audit retracted three more of my results: the level Taylor coefficients were a spurious regression, the Bai-Perron break dates vanished once residual autocorrelation was removed, and one relationship rested on a single observation. All three retractions are written into the pages.",
      ekonomiMethods: "Bai-Perron multiple structural breaks (my own dynamic programming implementation), Chen-Liu typed outlier detection, calendar-month-matched placebo and permutation tests, Benjamini-Hochberg false discovery correction, seasonal decomposition via a 2×12 centered moving average with a negative control, lag-augmented local projections (Montiel Olea &amp; Plagborg-Møller, 2021), Zivot-Andrews unit root test with a break, spurious regression diagnostics, and a high-frequency event study around central bank decision dates. Python (pandas, statsmodels) and the CBRT EVDS API; every table and chart reproduces from raw data with one command.",
